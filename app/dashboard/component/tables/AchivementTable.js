              ...
              <tr key={item.id} className="hover:bg-gray-50 transition">
                ...
                <td className="px-6 py-4">
                  <div className="flex justify-center gap-2">
                    <button className="px-2 py-1 border border-gray-300 rounded-lg cursor-pointer transition-all duration-300 ease-in-out hover:text-green-800 hover:border-green-500">
                      👁
                    </button>
                    <button className="px-2 py-1 border border-gray-300 rounded-lg cursor-pointer transition-all duration-300 ease-in-out hover:text-blue-800 hover:border-blue-500">
                      ✏
                    </button>
                    <button className="px-2 py-1 border border-gray-300 rounded-lg cursor-pointer transition-all duration-300 ease-in-out hover:text-red-600 hover:border-red-700">
                      🗑
                    </button>
                  </div>
                </td>
